...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="<?= base_url(); ?>public/assets/img/logo.png" style="width: 80px; height: 40px" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#services">Pendaftaran</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Daftar List</a></li>
                    <li class="nav-item"><a class="nav-link" href="#about">Bendahara</a></li>
